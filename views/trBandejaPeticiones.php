    ...
    <div class="card_container">
        ...
        <div class="tbl_wrapper">
            <div class="card text-bg-success mb-3" style="max-width: 38rem;">
                <div class="card-header"><span class="float-start">Petición # 1</span><button class="float-end" onclick="ventanaFormaPeticion()"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
                </div>
                <div class="card-body">
            ...
            <div class="card text-bg-primary mb-3" style="max-width: 38rem;">
                <div class="card-header"><span class="float-start">Petición # 2</span><button class="float-end" onclick="ventanaFormaPeticion()"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
                </div>
                <div class="card-body">
                    <h6 class="card-text">Departamento: </h6>
                    <h6 class="card-text">Fecha: </h6>
